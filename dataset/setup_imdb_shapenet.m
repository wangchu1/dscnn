...
opts.testFile = fullfile(datasetDir,'test.csv');
...
testAnno = csvread(opts.testFile, 1);
...
[~,testAnno(:,labelCol)] = ismember(testAnno(:,labelCol),classIds);
% meta
...
[imdb, nTestShapes] = add_to_imdb(imdb, 'test', 3, testAnno, opts); 
fprintf('done! %d shapes found.\n', nTestShapes); 
