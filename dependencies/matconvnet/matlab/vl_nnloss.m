...
%   scores X given the ground-truth labels C.
%
...
%
%   The array C contains the ground-truth labels. In the simplest case,
...
switch lower(opts.loss)
  case {'log', 'softmaxlog', 'mhinge', 'mshinge'}
    ...
    ci = offset + numPixelsPerImage * max(double(c) - 1,0) ;
end
